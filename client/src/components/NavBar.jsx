        ...
        <div className="flex items-center justify-between">
          ...
          {user ? (
            ...
            <div className="hidden md:flex space-x-10">
              ...
              <a href={Resume} download className='flex flex-wrap items-center gap-2 group tracking-tight font-medium cursor-pointer  rounded-lg px-3 py-2 text-lg bg-orange-300 text-secondary-900 hover:bg-blue-400 undefined w-auto'>
