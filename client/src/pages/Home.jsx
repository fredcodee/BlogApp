          ...
          <div className="grid grid-cols-3 gap-4 text-center pt-5">
            <div className="...">
              <div className='border-solid border-2 border-gray-500 rounded-lg p-4' style={{ height: '30rem' }}>
                ...
                <div>
                  <p className='font-bold pt-4 text-2xl'>HealthCheck</p>
                  <p className='pb-5'> A doctor's appointment SaaS web application, Designed to streamline the process of scheduling and managing medical appointments for both patients and healthcare providers. By leveraging the MERN stack—MongoDB, Express.js, React, and Node.js</p>
                  <a href='https://youtu.be/6i9N2oYgq7Y' className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-400 hover:bg-blue-70 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Watch Demo</a>
                  <a href='https://github.com/fredcodee/HealthCheck' className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-400 hover:bg-blue-700 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Github</a>
                </div>
              </div>
            </div>
            <div className="...">
            ...
            <div className="...">
              <div className='border-solid border-2 border-gray-500 rounded-lg p-4' style={{ height: '36rem' }}>
                <div>
                  <img src={projectExample} alt="project image" />
                </div>
                <div>
